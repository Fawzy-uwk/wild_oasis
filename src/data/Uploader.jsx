...
async function createBookings() {
  ...
  const finalBookings = bookings.map((booking) => {
    ...
    const nights_number = subtractDates(booking.end_date, booking.start_date);
    const cabin_price = nights_number * (cabin.regular_price - cabin.discount);
    const extras_price = booking.has_breakfast
      ? nights_number  * 15 * booking.guests_num
